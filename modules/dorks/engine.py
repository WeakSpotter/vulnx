...
class Dork:
    ...
    def __setdork__(self):
        ...
        if self.exploit is None:
            return dict(message="This exploit not valid")
        else:
            if self.exploit in wp_contentdorks:
                return dict(dork=wp_contentdorks[self.exploit])
            if self.exploit in wp_admindorks:
                return dict(dork=wp_admindorks[self.exploit])
            if self.exploit in wpajx:
                return dict(dork=wpajx[self.exploit])
            if self.exploit in wpindex:
                return dict(dork=wpindex[self.exploit])
            if self.exploit in joomla:
                return dict(dork=joomla[self.exploit])
            if self.exploit in prestashop:
                return dict(dork=prestashop[self.exploit])
    ...
    def __finddork__(self, content):
        ...
        if self.exploit in wp_contentdorks:
            dorks = re.findall(
                re.compile(
                    r"https?://+?\w+?[a-zA-Z0-9-_.]+?[a-zA-Z0-9-_.]?\w+\.\w+/?/wp-content/plugins/\w+"
                ),
                content,
            )
            if len(dorks) > 0:
            ...
            dorks = re.findall(
                re.compile(
                    r"https?://+?\w+?[a-zA-Z0-9-_.]+?[a-zA-Z0-9-_.]?\w+\.\w+/?/wp-admin/\w+"
                ),
                content,
            )
            if len(dorks) > 0:
            ...
            dorks = re.findall(
                re.compile(
                    r"https?://+?\w+?[a-zA-Z0-9-_.]+?[a-zA-Z0-9-_.]?\w+\.\w+/?/jm-ajax/upload_file/"
                ),
                content,
            )
            if len(dorks) > 0:
            ...
            dorks = re.findall(
                re.compile(
                    r"https?://+?\w+?[a-zA-Z0-9-_.]+?[a-zA-Z0-9-_.]?\w+\.\w+/index.php/wp-json/wp/"
                ),
                content,
            )
            if len(dorks) > 0:
            ...
            dorks = re.findall(
                re.compile(
                    r"https?://+?\w+?[a-zA-Z0-9-_.]+?[a-zA-Z0-9-_.]?\w+\.\w+/index.php?option=com_jce"
                ),
                content,
            )
            if len(dorks) > 0:
            ...
            dorks = re.findall(
                re.compile(
                    r"https?://+?\w+?[a-zA-Z0-9-_.]+?[a-zA-Z0-9-_.]?\w+\.\w+/?/modules/\w+"
                ),
                content,
            )
            if len(dorks) > 0:
            ...
            for number_page in range(0, pages, 10):
                ...
                if number_page == 0:
                    ...
                    if self.detect_captcha(self._google_singlepage_()):
                        print(
                            " {0} Bot Detected The block will expire shortly".format(
                                bad
                            )
                        )
                    else:
